...
extension CVCalendarMonthContentViewController {
    ...
    public func updateSelection() {
        ...
        if let presentedMonthView = monthViews[presented] {
            ...
            if presented.convertedDate()!.compare(current.convertedDate()!) == ComparisonResult.orderedAscending {
    ...
    public func selectDayViewWithDayNoAnimate(_ day: Int, inMonthView monthView: CVCalendarMonthView)  {
        let coordinator = calendarView.coordinator
        monthView.mapDayViews { dayView in
